...
# Delete old NMOS directory
echo -e "${TAG} Deleting old sony-nmos-Arm86_release directory..."
rm -rf $work/sony-nmos-aarch64Build

# Configure sony-nmos
echo -e "${TAG} Configuring sony-nmos"
$work/scripts/configure-build-aarch64.sh
...
# Build sony-nmos
cd ${work}/sony-nmos-aarch64Build/sony-nmos-aarch64_release
...
NMOS_EXEC_SOURCE=${work}/sony-nmos-aarch64Build/sony-nmos-aarch64_release/libs-ext/nmos-cpp/Development
