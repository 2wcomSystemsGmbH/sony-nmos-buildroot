...
echo -e "${TAG} Deleting old sony-nmos-86_release directory..."
rm -rf $work/sony-nmos-x86Build

# Configure sony-nmos
echo -e "${TAG} Configuring sony-nmos"
$work/scripts/configure-build-x86_64.sh
...
# Build sony-nmos
cd ${work}/sony-nmos-x86Build/sony-nmos-x86_release
...
NMOS_EXEC_SOURCE=${work}/sony-nmos-x86Build/sony-nmos-x86_release/libs-ext/nmos-cpp/Development
